...
app.get('/changeWeight/', profile.changeWeight);
app.get('/changeHeight/', profile.changeHeight);
app.get('/changeAge/', profile.changeAge);
app.get('/changeSex/', profile.changeSex);
